...
- Explain the benefits of creating a minimal reproducible example, for you and for others.
...
Sometimes, Mickey's code doesn't work as expected and they go to their colleague, a fifth-year graduate student called Remy, for help. Remy has spent many hours sitting with Mickey, helping to work through various errors. But Remy will be writing up their dissertation soon, so they won't have as much time to help with debugging. 
...
Remy emphasizes to Mickey that they are still happy to be a helper, but that since they won't have as much time to devote to debugging in the future, following this road map first will make the helping process more efficient. 
...
::::::::::::::::::::::::::::::::::::: keypoints 
- Throughout this lesson, we will be walking through a "road map" to getting unstuck in R. Briefly, you can start by applying some basic debugging strategies to narrow down the problem, and if you're still stuck, you can create a minimal reproducible example ("reprex") to get help.
- Helpers can more easily debug your code if your reprex is simple and minimal and reproduces the problem so that they can tinker with it themselves.
- In the process of building a reprex, you will often find the solution yourself!
