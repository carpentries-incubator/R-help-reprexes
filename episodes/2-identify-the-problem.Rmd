...
Using this information, we can change our code to put the arguments in the right order--first the name of the dataset for the `data` argument, and then the `aes()` call for the mapping.
...
This tells us two things. For one, we've misspelled *Dipodomys*, which we can now fix.
