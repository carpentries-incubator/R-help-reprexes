...
Then, you focus in on the spectabilis-specific exclosures, compute counts and proportions for those, and visualize the relative proportions in the spectabilis exclosure versus the control.
...
So far, you've been saving all of your analysis in a script called "krat-analysis.R". 
